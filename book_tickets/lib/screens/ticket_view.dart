      ...
      child: Container(
        ...
        child: Column(
          children: [
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text("${ticket['flyingTime']}", style: Styles.headLineStyle4.copyWith(color: Colors.white)),
            ...
            /*Showing Orange Part of the ticket Box*/
            Container(
                    ...
                    child: LayoutBuilder(
                      builder: (BuildContext context, BoxConstraints constraints) {
                        return Flex(
                          ...
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          mainAxisSize: MainAxisSize.max ,
                          children: List.generate((constraints.constrainWidth()/20).floor(), (index) => const SizedBox(
                            width: 5,
                            height: 1,
                            child: DecoratedBox(
                              decoration: BoxDecoration(
            ...
            /*Bottom card of the ticket card*/
            Container(
              decoration: BoxDecoration(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text("${ticket['departureTime']}", style: Styles.headLineStyle3.copyWith(color: Colors.white)),
                          const Gap(5),
